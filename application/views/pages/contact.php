		...
		<div class="col-md-6">
			<form action="">
				<div class="form-group">
					...
					<input 	type="text" class="form-control" name="contactedname" id="contactedname"  placeholder="Enter Name"> 
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Email address</label>
						 <input	type="email" class="form-control" name="contactedEmail" id="contactedEmail" aria-describedby="emailHelp" placeholder="Enter email"> 
				...
				<div class="form-group">
					...
					<input 	type="text" class="form-control" name="contactedquery" id="contactedquery"  placeholder="Enter query subject"> 
				</div>
				<div class="form-group">
					<label for="contactedmessage">Query Details</label>
					<textarea class="form-control" id="contactedmessage" name ="contactedmessage" rows="3"></textarea>
				</div>
