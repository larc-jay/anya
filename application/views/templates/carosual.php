<div id="highlights" class="carousel slide" data-ride="carousel">
      ...
      <ol class="carousel-indicators">
        ...
        <li data-target="#myCarousel" return="false"  data-slide-to="1" class=""></li>
        <li data-target="#myCarousel" return="false"  data-slide-to="2" class=""></li>
        <li data-target="#myCarousel" return="false"  data-slide-to="3" class=""></li>
        <li data-target="#myCarousel" return="false"  data-slide-to="4" class=""></li>
        <li data-target="#myCarousel" return="false"  data-slide-to="5" class=""></li>
      </ol>
      ...
      <a class="left carousel-control" href="#highlights" role="button" data-slide="prev"  return="false" >
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="right carousel-control" href="#highlights" role="button" data-slide="next"  return="false" >
